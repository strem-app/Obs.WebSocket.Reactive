...
namespace Obs.v4.WebSocket
{
    public interface IOBSWebSocket
    {
        ...
        /// </summary>
        event EventHandler<OBSErrorEventArgs>? OBSError;

        /// <summary>
        /// Raised when a request is sent.
        /// </summary>
        event EventHandler<RequestData>? RequestSent;

        /// <summary>
        /// Raised when any "update-type" event is received.
        /// </summary>
        event EventHandler<JObject>? EventReceived;

        /// <summary>
        /// Raised when a request's response is received.
        /// </summary>
        event EventHandler<JObject>? ResponseReceived;

        /// <summary>
        /// Triggered when switching to another scene
        /// </summary>
        event EventHandler<SceneChangeEventArgs>? SceneChanged;
        ...
        /// </summary>
        event EventHandler<SourceOrderChangedEventArgs>? SourceOrderChanged;

        /// <summary>
        /// Triggered when a new item is added to the item list of the specified scene
        /// </summary>
        event EventHandler<SceneItemUpdatedEventArgs>? SceneItemAdded;

        /// <summary>
        /// Triggered when an item is removed from the item list of the specified scene
        /// </summary>
        event EventHandler<SceneItemUpdatedEventArgs>? SceneItemRemoved;

        /// <summary>
        /// Triggered when the visibility of a scene item changes
        /// </summary>
        event EventHandler<SceneItemVisibilityChangedEventArgs>? SceneItemVisibilityChanged;

        /// <summary>
        /// Triggered when the lock status of a scene item changes
        /// </summary>
        event EventHandler<SceneItemLockChangedEventArgs>? SceneItemLockChanged;
        ...
        /// </summary>
        event EventHandler<TransitionChangeEventArgs>? TransitionChanged;

        /// <summary>
        /// Triggered when the current transition duration is changed
        /// </summary>
        event EventHandler<TransitionDurationChangeEventArgs>? TransitionDurationChanged;

        /// <summary>
        /// Triggered when a transition is created or removed
        /// </summary>
        event EventHandler? TransitionListChanged;

        /// <summary>
        /// Triggered when a transition between two scenes starts. Followed by <see cref="OBSWebSocket.SceneChanged"/>
        /// </summary>
        event EventHandler<TransitionBeginEventArgs>? TransitionBegin;

        /// <summary>
        /// A transition (other than "cut") has ended. Added in v4.8.0
        /// </summary>
        event EventHandler<TransitionEndEventArgs>? TransitionEnd;

        /// <summary>
        /// A stinger transition has finished playing its video. Added in v4.8.0
        /// </summary>
        event EventHandler<TransitionVideoEndEventArgs>? TransitionVideoEnd;
        ...
        /// </summary>
        event EventHandler<OutputStateChangedEventArgs>? StreamingStateChanged;

        /// <summary>
        /// Triggered when the recording output state changes
        /// </summary>
        event EventHandler<OutputStateChangedEventArgs>? RecordingStateChanged;
        ...
        /// </summary>
        event EventHandler<StreamStatusEventArgs>? StreamStatus;

        /// <summary>
        /// Triggered when the preview scene selection changes (Studio Mode only)
        /// </summary>
        event EventHandler<SceneChangeEventArgs>? PreviewSceneChanged;

        /// <summary>
        /// Triggered when Studio Mode is turned on or off
        /// </summary>
        event EventHandler<StudioModeChangeEventArgs>? StudioModeSwitched;

        /// <summary>
        /// Triggered when OBS exits
        /// </summary>
        event EventHandler? OBSExit;
        ...
        /// </summary>
        event EventHandler<SceneItemSelectionEventArgs>? SceneItemDeselected;

        /// <summary>
        /// A scene item is selected
        /// </summary>
        event EventHandler<SceneItemSelectionEventArgs>? SceneItemSelected;
        ...
        /// </summary>
        event EventHandler<SourceAudioMixersChangedEventArgs>? SourceAudioMixersChanged;

        /// <summary>
        /// The audio sync offset of a source has changed
        /// </summary>
        event EventHandler<SourceAudioSyncOffsetEventArgs>? SourceAudioSyncOffsetChanged;

        /// <summary>
        /// A source has been created. A source can be an input, a scene or a transition.
        /// </summary>
        event EventHandler<SourceCreatedEventArgs>? SourceCreated;

        /// <summary>
        /// A source has been destroyed/removed. A source can be an input, a scene or a transition.
        /// </summary>
        event EventHandler<SourceDestroyedEventArgs>? SourceDestroyed;

        /// <summary>
        /// A filter was added to a source
        /// </summary>
        event EventHandler<SourceFilterAddedEventArgs>? SourceFilterAdded;
        ...
        /// </summary>
        event EventHandler<SourceFiltersReorderedEventArgs>? SourceFiltersReordered;

        /// <summary>
        /// Triggered when the visibility of a filter has changed
        /// </summary>
        event EventHandler<SourceFilterVisibilityChangedEventArgs>? SourceFilterVisibilityChanged;

        /// <summary>
        /// A source has been muted or unmuted
        /// </summary>
        event EventHandler<SourceMuteStateChangedEventArgs>? SourceMuteStateChanged;

        /// <summary>
        /// A source has been renamed
        /// </summary>
        event EventHandler<SourceRenamedEventArgs>? SourceRenamed;

        /// <summary>
        /// The volume of a source has changed
        /// </summary>
        event EventHandler<SourceVolumeChangedEventArgs>? SourceVolumeChanged;

        /// <summary>
        /// An event was received that Obs.Websockets.v4 does not have a defined event handler for.
        /// </summary>
        event EventHandler<JObject>? UnhandledEvent;

        /// <summary>
        /// A custom broadcast message was received
        /// </summary>
        event EventHandler<BroadcastCustomMessageReceivedEventArgs>? BroadcastCustomMessageReceived;
